...
<head>
    ...
    <style type="text/css">
        ...
        .tombol_login { /* Untuk tombol Cari */
             background: #47C0DB;
            color: white;
            font-size: 11pt;
            border: none;
...
<body>
    ...
    <div class="posisi_tombol"> 
        ...
        <a href="laporan_print.php">Print Data Barang</a>
        <a href="proses_barang.php?action=delete_all" onclick="return confirm('Yakin menghapus semua data?')">Hapus Semua Data</a>
    </div>
